...
extern const char claim_certificate_pem_crt[];
extern const char claim_private_pem_key[];
extern const char thing_certificate_pem_crt[];
extern const char thing_private_pem_key[];
...
void app_init()
{
    ...
    // sysConfig.s_mqttClientConfig.pClaimCertStr = (char *)claim_certificate_pem_crt;
    // sysConfig.s_mqttClientConfig.pClaimPrivateKeyStr = (char *)claim_private_pem_key;

    sysConfig.s_mqttClientConfig.pThingCertStr = (char *)thing_certificate_pem_crt;
    sysConfig.s_mqttClientConfig.pThingPrivateKeyStr = (char *)thing_private_pem_key;

    sysConfig.s_modemConfig.model = QUECTEL_M95;
    ...
    sysConfig.s_modemConfig.pwKeyPin_u8 = MODEM_POWERKEY_GPIO_PIN;
